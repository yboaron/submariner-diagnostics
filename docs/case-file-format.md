...
See `cases/examples/case-001-aws-missing-gateway-sg.yaml` for a complete example.
...
2. **Review**: Edit `cases/review/case-XXX.yaml`
3. **Enhance**: `/workflow review-and-enhance-case cases/review/case-XXX.yaml`
...
- [Example Case File](../cases/examples/case-001-aws-missing-gateway-sg.yaml)
