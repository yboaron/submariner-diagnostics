...
3. Generates a case file: `cases/review/case-XXX.yaml`
...
# Output: cases/review/case-001-aws-gateway-sg.yaml

# Step 2: Review the case file
cat cases/review/case-001-aws-gateway-sg.yaml
vim cases/review/case-001-aws-gateway-sg.yaml  # Edit if needed

# Step 3: Auto-generate enhancements
/workflow review-and-enhance-case cases/review/case-001-aws-gateway-sg.yaml
...
**A:** Workflows are part of the repository, so they're available on any branch that has them. The enhancement workflow will create a new branch for you.
